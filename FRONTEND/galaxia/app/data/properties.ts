...
export const properties: Record<string, PropertyData> = {
        ...
        subProperties: [
            {
                ...
                pricing: {
                    ...
                    dateOverrides: { "2026-08-14": 7500, "2026-08-15": 9500, "2026-10-02": 7500, "2026-10-03": 13000 },
                },
            },
            {
                id: "alta",
            ...
            },
            {
                ...
                pricing: {
                    ...
                    dateOverrides: { "2026-08-14": 12500, "2026-08-15": 14000, "2026-10-02": 12500, "2026-10-03": 14000 },
                },
            },
            {
                id: "cypress",
                ...
                pricing: {
                    ...
                    dateOverrides: { "2026-08-14": 7500, "2026-08-15": 7500, "2026-10-02": 7500, "2026-10-03": 7500 },
                },
            },
        ],
        ...
        subProperties: [
            {
                ...
                pricing: {
                    ...
                    weekend: { price: "5,950", persons: "2 persons with meals" },
                    saturday: { price: "6,950", persons: "2 persons with meals" },
                    dateOverrides: { "2026-08-14": 7950, "2026-08-15": 8500, "2026-10-02": 6950, "2026-10-03": 7950 }
                },
            },
            {
                id: "family-cottage",
                ...
                image: "",
                configuration: ["2 Double Beds", "Smart TV", "Air Conditioner", "Washroom", "Indoor Private Pool", "Garden Sitting Area", "Gaming Zone", "WiFi", "Boating"],
                maxPersons: 8,
                maxAdults: 6,
                maxKids: 4,
                pricing: {
                    ...
                    dateOverrides: { "2026-08-14": 11000, "2026-08-15": 13500, "2026-10-02": 11000, "2026-10-03": 13000 }
                },
            },
        ],
    ...
    "la-paraiso": {
        ...
        pricing: {
            ...
            primeDates: "8,500",
            dateOverrides: { "2026-08-14": 8500, "2026-08-15": 9500, "2026-10-02": 8500, "2026-10-03": 9500 },
            extraAdult: "1,200",
    ...
    "heavenly-villa": {
        ...
        pricing: {
            ...
            dateOverrides: { "2026-08-14": 5950, "2026-08-15": 5950, "2026-10-02": 5950, "2026-10-03": 5950 },
            extraAdult: "800",
    ...
    "mount-view": {
        ...
        checkOut: "10:00 AM",
        pricing: {
            weekday: { price: "3,000", persons: "2 persons" },
            weekend: { price: "4,000", persons: "2 persons" },
            primeDates: "5,000",
            dateOverrides: { "2026-08-14": 5950, "2026-08-15": 5950, "2026-10-02": 5000, "2026-10-03": 5000 },
            extraAdult: "800",
            kidsCharge: "500 (5–12 yrs)",
            special: [
    ...
    "hill-view": {
        ...
        checkOut: "10:00 AM",
        pricing: {
            weekday: { price: "2,000", persons: "2 persons" },
            weekend: { price: "3,000", persons: "2 persons" },
            primeDates: "4,000",
            dateOverrides: { "2026-08-14": 4950, "2026-08-15": 4950, "2026-10-02": 4000, "2026-10-03": 4000 },
            extraAdult: "600",
