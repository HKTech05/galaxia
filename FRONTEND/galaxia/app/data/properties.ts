...
export const properties: Record<string, PropertyData> = {
    ...
    euphoria: {
        ...
        longDescription:
            "Euphoria is not just a villa — it's a feeling. Step into this heavenly studio retreat featuring a private indoor swimming pool that's exclusively yours. A charming swing by the pool sets the mood for lazy afternoons, while the studio room with its queen bed and smart TV ensures comfort around the clock. Whether you're planning a romantic getaway or a peaceful solo retreat, Euphoria delivers paradise indoors.",
