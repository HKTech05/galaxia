                            ...
                            {pricing ? (
                                <>
                                    <div className="space-y-2.5 text-sm">
                                        ...
                                        {pricing.specialDiscount > 0 && <div className="flex justify-between text-[#16a34a] font-semibold"><span className="text-[#16a34a]">{propertyName?.toLowerCase().includes("la paraiso") ? "Discount" : "Special Guest Discount"}</span><span>-{fmtCurrency(pricing.specialDiscount)}</span></div>}
