                    ...
                    <div className="lg:col-span-2 space-y-5">
                        ...
                        <div className="relative rounded-2xl bg-gradient-to-br from-cel-card to-rose-dark/5 border border-cel-border p-6 overflow-hidden transition-all duration-300 hover:border-rose-medium/30">
                            <div className="relative z-10">
                                ...
                                <a href="tel:+919892294042" className="font-inter text-sm text-cel-text-secondary hover:text-rose-light transition-colors block mb-1">Call us at +91 98922 94042</a>
                                <p className="font-inter text-xs text-cel-text-muted mb-3">Mon – Sun, 10 AM – 10 PM</p>
                                <a href="https://wa.me/919892294042" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-600/15 border border-green-500/30 text-green-400 font-inter text-xs font-medium hover:bg-green-600/25 transition-all">
