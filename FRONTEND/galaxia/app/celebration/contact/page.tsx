...
export default function DDContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simulate submit — hook to real endpoint later
        ...
        <div className="min-h-screen bg-cel-bg">
            ...
            <section className="relative overflow-hidden pt-28 pb-20 sm:pt-36 sm:pb-28">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute -top-32 -left-32 w-96 h-96 bg-rose-dark/20 rounded-full blur-[120px] animate-pulse" />
                    <div className="absolute top-1/2 -right-48 w-[500px] h-[500px] bg-rose-medium/15 rounded-full blur-[150px] animate-pulse" style={{ animationDelay: "1s" }} />
                    <div className="absolute -bottom-24 left-1/3 w-72 h-72 bg-rose-dark/10 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: "2s" }} />
                </div>
                ...
                <div className="absolute inset-0 pointer-events-none">
                    {[...Array(6)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute w-1 h-1 bg-rose-medium/30 rounded-full animate-float"
                            style={{
                                left: `${15 + i * 14}%`,
                                top: `${20 + (i % 3) * 25}%`,
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <h1 className="font-cinzel text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-5">
                        CONTACT <span className="bg-gradient-to-r from-rose-light via-rose-medium to-rose-dark bg-clip-text text-transparent">US</span>
                    </h1>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-20 sm:pb-28 -mt-6">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        {/* Card: Location */}
                        <div className="group relative rounded-2xl bg-gradient-to-br from-cel-card to-rose-dark/5 border border-cel-border p-6 overflow-hidden hover:border-rose-medium/40 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(159,53,58,0.15)]">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-rose-dark/10 rounded-full blur-[60px] -mr-16 -mt-16 group-hover:bg-rose-dark/20 transition-colors duration-500" />
                            <div className="relative z-10">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-dark/40 to-rose-medium/20 border border-rose-medium/30 flex items-center justify-center mb-4 shadow-lg shadow-rose-dark/10">
                                ...
                                <p className="font-inter text-xs text-cel-text-muted mt-1">5 min from Wadala Station</p>
                            </div>
                        </div>

                        {/* Card: Phone */}
                        <div className="group relative rounded-2xl bg-gradient-to-br from-cel-card to-rose-dark/5 border border-cel-border p-6 overflow-hidden hover:border-rose-medium/40 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(159,53,58,0.15)]">
                            <div className="absolute bottom-0 left-0 w-32 h-32 bg-rose-dark/10 rounded-full blur-[60px] -ml-16 -mb-16 group-hover:bg-rose-dark/20 transition-colors duration-500" />
                            <div className="relative z-10">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-dark/40 to-rose-medium/20 border border-rose-medium/30 flex items-center justify-center mb-4 shadow-lg shadow-rose-dark/10">
                                    <svg className="w-5 h-5 text-rose-light" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                </div>
                                <h3 className="font-cinzel text-base font-bold text-rose-light mb-1">Call Us</h3>
                                <a href="tel:+919876543210" className="font-inter text-sm text-cel-text-secondary hover:text-rose-light transition-colors">+91 98765 43210</a>
                                <p className="font-inter text-xs text-cel-text-muted mt-1">Mon – Sun, 10 AM – 10 PM</p>
                            </div>
                        </div>

                        {/* Card: Social */}
                        <div className="group relative rounded-2xl bg-gradient-to-br from-cel-card to-rose-dark/5 border border-cel-border p-6 overflow-hidden hover:border-rose-medium/40 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(159,53,58,0.15)]">
                            <div className="absolute top-0 left-0 w-32 h-32 bg-rose-dark/10 rounded-full blur-[60px] -ml-16 -mt-16 group-hover:bg-rose-dark/20 transition-colors duration-500" />
                            <div className="relative z-10">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-dark/40 to-rose-medium/20 border border-rose-medium/30 flex items-center justify-center mb-4 shadow-lg shadow-rose-dark/10">
                                    <svg className="w-5 h-5 text-rose-light" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                                </div>
                                <h3 className="font-cinzel text-base font-bold text-rose-light mb-3">Follow Us</h3>
                                <div className="flex items-center gap-3">
                                    <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-cel-border bg-cel-bg/50 flex items-center justify-center text-cel-text-secondary hover:text-rose-medium hover:border-rose-medium/40 hover:scale-110 transition-all duration-300">
                                    ...
                                    <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-cel-border bg-cel-bg/50 flex items-center justify-center text-cel-text-secondary hover:text-green-400 hover:border-green-400/40 hover:scale-110 transition-all duration-300">
                    ...
                    <div className="lg:col-span-3">
                        <div className="relative rounded-2xl bg-cel-card border border-cel-border p-8 sm:p-10 overflow-hidden">
                            ...
                            <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-rose-dark/10 to-transparent pointer-events-none" />
                            <div className="absolute bottom-0 left-0 w-40 h-40 bg-gradient-to-tr from-rose-dark/5 to-transparent pointer-events-none" />
                            ...
                            <div className="relative z-10">
                                ...
                                {formStatus === "sent" ? (
                                    <div className="text-center py-16">
                                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-500/20 to-green-600/10 border border-green-500/30 flex items-center justify-center mx-auto mb-6 animate-bounce-once">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-gradient-to-r from-rose-dark to-rose-medium text-white font-cinzel font-semibold text-sm py-4 rounded-xl hover:shadow-lg hover:shadow-rose-dark/30 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60"
                                        >
                                            {formStatus === "sending" ? (
                                                <>
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            { q: "Is there parking available?", a: "Yes, free parking is available for all guests at our premises." },
                            ...
                            { q: "How do I cancel or reschedule?", a: "You can cancel or reschedule from your Dashboard. Cancellation policies vary by package — please check at the time of booking." },
                        ].map((faq, i) => (
