                                ...
                                {formStatus === "sent" ? (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-gradient-to-r from-rose-dark to-rose-medium text-white font-cinzel font-semibold text-sm py-4 rounded-xl hover:opacity-90 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60"
                                        >
                                            {formStatus === "sending" ? (
                                                <>
