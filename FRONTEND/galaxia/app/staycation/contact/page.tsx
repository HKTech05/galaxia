                    ...
                    <div id="form-section" data-animate className={`transition-all duration-1000 delay-300 ${visible["form-section"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 sm:gap-14">
                            ...
                            <div ref={formRef} className="lg:col-span-3">
                                ...
                                {/* Concierge & Direct Support Card */}
                                <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-[#faf8f4] via-white to-slate-50 border border-border-light shadow-sm">
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="w-9 h-9 rounded-xl bg-antique-gold/10 text-antique-gold flex items-center justify-center shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-cinzel text-sm font-bold text-text-primary">Need Instant Booking Support?</h4>
                                            <p className="font-inter text-xs text-text-secondary">Speak directly with our concierge team for real-time villa availability</p>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                                        <a href="tel:+918169519564" className="flex items-center gap-3 p-3 rounded-xl bg-white border border-border-light hover:border-antique-gold/60 hover:shadow-sm transition-all group">
                                            ...
                                            <div className="overflow-hidden">
                                                <p className="font-inter text-[10px] text-text-muted uppercase font-bold tracking-wider">All Properties</p>
                                                <p className="font-inter text-xs font-bold text-text-primary">+91 81695 19564</p>
                                            </div>
                                        </a>
                                        <a href="tel:+919987734458" className="flex items-center gap-3 p-3 rounded-xl bg-white border border-border-light hover:border-antique-gold/60 hover:shadow-sm transition-all group">
                                            <div className="w-8 h-8 rounded-lg bg-antique-gold/10 text-antique-gold flex items-center justify-center shrink-0 group-hover:bg-antique-gold group-hover:text-white transition-colors">
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                            </div>
                                            <div className="overflow-hidden">
                                                <p className="font-inter text-[10px] text-text-muted uppercase font-bold tracking-wider">Amstel Nest</p>
                                                <p className="font-inter text-xs font-bold text-text-primary">+91 99877 34458</p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="lg:col-span-2 flex flex-col gap-6">
                                {/* Map */}
                                <div className="rounded-2xl overflow-hidden border border-border-light h-56 lg:h-64 shadow-sm">
                                    <iframe
                                ...
                                {/* Quick Links */}
                                <div className="bg-[#faf8f4] rounded-2xl border border-border-light p-5">
                                    <h4 className="font-cinzel text-xs font-bold text-text-primary mb-3 uppercase tracking-wider">Quick Links</h4>
                                    <div className="grid grid-cols-2 gap-2">
                                        {[
                                            ...
                                            <Link key={link.href} href={link.href} className="group flex items-center justify-between py-2 px-2.5 rounded-lg bg-white border border-border-light/60 hover:border-antique-gold/40 hover:shadow-sm transition-all">
                                                <span className="font-inter text-xs text-text-secondary group-hover:text-antique-gold transition-colors truncate">{link.label}</span>
                                                <svg className="w-3.5 h-3.5 text-text-muted group-hover:text-antique-gold shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                                            </Link>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-2xl border border-border-light p-5">
                                    <h4 className="font-cinzel text-xs font-bold text-text-primary mb-3 uppercase tracking-wider">Follow Us on Instagram</h4>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        {[
                                            ...
                                            <a key={s.handle} href={s.href} target="_blank" rel="noopener noreferrer"
                                                className="group flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-border-light hover:border-antique-gold/40 hover:bg-white hover:shadow-sm transition-all duration-200"
                                            >
                                                <div className="flex items-center gap-2 overflow-hidden">
                                                    <div className="w-7 h-7 rounded-lg bg-antique-gold/10 text-antique-gold flex items-center justify-center shrink-0 group-hover:bg-antique-gold group-hover:text-white transition-colors">
                                                    ...
                                                    <div className="overflow-hidden">
                                                        <p className="font-inter text-xs font-semibold text-text-primary truncate">{s.name}</p>
                                                        <p className="font-inter text-[9px] text-text-muted truncate">{s.handle}</p>
                                                    </div>
                                                </div>
                                                <svg className="w-3 h-3 text-text-muted group-hover:text-antique-gold shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                                            </a>
                                        ))}
                                    </div>
                                </div>
