                            ...
                            <form onSubmit={handleFormSubmit}>
                                ...
                                <div className="mb-6 p-4 border border-antique-gold/30 rounded-lg bg-antique-gold/5">
                                    <div className="flex items-start gap-3">
                                        ...
                                        {celebrationImageUrl && (
                                            <button type="button" onClick={(e) => { e.preventDefault(); setCelebrationPreviewOpen(true); }} className="shrink-0 w-[78px] h-[78px] sm:w-[92px] sm:h-[92px] rounded-lg overflow-hidden border border-antique-gold/30 hover:border-antique-gold hover:shadow-md transition-all cursor-pointer relative group">
