...
export default function BookMultiPage() {
                    ...
                    try {
                        ...
                        if (ambData.subPropertyPricing && ambData.subProperties) {
                            const ambOverridesMap: Record<string, Record<string, number>> = {
                                "take-1": { "2026-08-14": 7500, "2026-08-15": 9500, "2026-10-02": 7500, "2026-10-03": 13000 },
                                "alta": { "2026-08-14": 7500, "2026-08-15": 9500, "2026-10-02": 7500, "2026-10-03": 13000 },
                                "santorini": { "2026-08-14": 7500, "2026-08-15": 9500, "2026-10-02": 7500, "2026-10-03": 13000 },
    ...
    const specialDiscount = (() => {
        ...
        let totalDiscount = 0;
        for (const item of cart) {
            const pSlug = (item.property || "ambrose").toLowerCase();
                                ...
                                return (
                                    <div key={item.villaId} className="border border-border-light rounded-lg p-4 mb-3">
                                        <div className="flex justify-between items-center">
                                            <div>
                                                <span className="text-[10px] text-dark-gold font-inter uppercase tracking-wider">{item.property === "amstel-nest" ? "Amstel Nest" : (item.property || 'ambrose')} · {item.theme}</span>
