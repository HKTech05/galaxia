                            ...
                            <div className="space-y-5 sm:space-y-6">
                                ...
                                <div className="rounded-xl border border-border-light bg-white p-5 sm:p-6 shadow-sm">
                                    ...
                                    {property.foodPolicy.menuFile && (
                                        <a href={property.foodPolicy.menuFile} onClick={(e) => handleDownload(e, property.foodPolicy.menuFile!)} className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg bg-gradient-to-r from-antique-gold to-dark-gold text-white font-inter text-xs font-medium hover:shadow-md hover:shadow-antique-gold/20 transition-all duration-300">
                                            {isDownloading ? (
