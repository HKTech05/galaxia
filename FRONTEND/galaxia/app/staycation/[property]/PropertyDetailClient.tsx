                            ...
                            <div className="space-y-5 sm:space-y-6">
                                ...
                                <div className="rounded-xl border border-border-light bg-white p-5 sm:p-6 shadow-sm">
                                    ...
                                    {property.foodPolicy.menuFile && (
                                        <a href={`/api/download?url=${encodeURIComponent(property.foodPolicy.menuFile!)}&name=${encodeURIComponent(property.name + "-Menu")}`} download className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg bg-gradient-to-r from-antique-gold to-dark-gold text-white font-inter text-xs font-medium hover:shadow-md hover:shadow-antique-gold/20 transition-all duration-300">
                                ...
                                <div className="rounded-xl border border-border-light bg-white p-5 sm:p-6 shadow-sm">
                                    <h3 className="font-cinzel text-base sm:text-lg font-semibold text-text-primary mb-4">Cancellation Policy</h3>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                <details className="group border border-border-light rounded-lg">
                                    ...
                                    <div className="px-4 pb-4 text-text-secondary font-inter text-sm">
                                         Local taxis and auto-rickshaws available. Contact Ashok: <a href="tel:+918983736999" className="text-antique-gold hover:text-dark-gold transition-colors font-medium">+91 89837 36999</a> for pre-booking an auto rickshaw.
                                    </div>
                                </details>
                            </div>
                        </div>
