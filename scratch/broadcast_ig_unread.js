...
async function processSession(s) {
  ...
  return { botType: s.botType, apiSuccess: apiRes.success };
}

async function main() {
  console.log("Starting high-speed broadcast to UNREAD Non-Human Staycation IG conversations...\n");
  ...
  console.log(`Found ${sessions.length} target unread sessions.`);
  ...
  for (let i = 0; i < sessions.length; i += chunkSize) {
    ...
    console.log(`Progress: ${totalProcessed}/${sessions.length} unread sessions processed.`);
  }

  console.log("\n==============================================");
  console.log("UNREAD BROADCAST COMPLETED SUCCESSFULLY");
  console.log("==============================================");
  console.log(`Total Unread Staycation IG Conversations Processed: ${sessions.length}`);
  console.log(`Database Records Updated & Messages Saved: ${totalProcessed}`);
